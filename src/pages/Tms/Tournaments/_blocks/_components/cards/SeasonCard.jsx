          ...
          <Row gutter={[24, 24]} className="mt-4">
            ...
            <Col xs={12} md={12}>
              <Form.Item
                ...
                rules={[{ required: true, message: "Please enter season description" }]}
              >
                <TextArea 
                  placeholder="Enter detailed description of the season" 
                  rows={4}
              ...
              {(fields, { add, remove }) => (
                <>
                  ...
                  <Form.Item>
                    <Button
                      type="dashed"
                      onClick={() => add({ field: "COUNTRY", operator: "=", value: "" })}
                      icon={<PlusCircle size={16} />}
