...
import { Modal, Form, Input, Select, Button, Avatar, Tabs, Upload, Typography } from 'antd';
            ...
            >
                ...
                <Form.Item label="Profile Picture">
                    <Tabs activeKey={activeTab} onChange={handleTabChange}>
                        <TabPane tab="From URL" key="url">
                            <Form.Item
                                name="profile_picture_url"
                                rules={[
                                    { required: activeTab === 'url', message: 'Please enter profile picture URL' },
                        ...
                        <TabPane tab="Upload File" key="file">
                            <Form.Item name="logo_file" noStyle>
                                <Upload
                                    listType="picture"
                                    maxCount={1}
                                    showUploadList={{ showRemoveIcon: true }}
                                    beforeUpload={(file) => {
                                        setLogoFile(file); // Save the selected file
                                        setPreviewImage(URL.createObjectURL(file)); // Show preview
                                        return false; // Prevent auto-upload
                                    }}
                                    fileList={logoFile ? [logoFile] : []} // 🔥 This ensures it's always an array
                                    onRemove={() => {
                                        setLogoFile(null);
                                        setPreviewImage(null);
                                    }}
